# Footballia — Android TV app

Android TV client for [footballia.eu](https://footballia.eu), Kotlin + Jetpack Compose (Compose for TV). This is a functional port of the Swift app in `../Footballia/`. See [`CLAUDE.md`](CLAUDE.md) for architecture notes.
